...
@Component({
  selector: 'app-update-professeurs',
  templateUrl: './update-professeurs.component.html',
  styleUrls: ['./update-professeurs.component.css'],
})
export class UpdateProfesseursComponent implements OnInit {
  userid!: number;
  firstName!: string;
  lastName!: string;
  roles!: string;
