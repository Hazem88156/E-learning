...
public class AuthController {
	...
	public AuthenticateDTO login(@RequestBody AuthBody data) {
		...
		//String username = data.getEmail();
			...
			userDto.setClassesEtudiant(user.getClassesEtudiant());
			System.out.println("classe"+user.getClassesEtudiant());
	...
	@GetMapping(path="/Images/{id}")
	 ...
	 @GetMapping("/userstatusroles/{status}/{roles}")
		public List<UserEntity> getAllUser(@PathVariable String status, @PathVariable RoleEntity roles) {
			System.out.println("\n\n\n -+"
					+ "select user avec condition roles et status");
			return userService.findByStatusAndRoles(status,roles);
		}
	 @GetMapping("/usersss/{roles}")
		public List<UserEntity> getAllUsers(@PathVariable RoleEntity roles) {
			System.out.println("\n\n\n -+"
					+ "	get user");
			return userService.findByRoles(roles);
		}
      @GetMapping("userdetail/{id}")
      public UserEntity userDetail(@PathVariable Long id) {
